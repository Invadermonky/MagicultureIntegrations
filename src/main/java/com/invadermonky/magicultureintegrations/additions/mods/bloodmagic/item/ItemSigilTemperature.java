package com.invadermonky.magicultureintegrations.additions.mods.bloodmagic.item;
...
public class ItemSigilTemperature extends ItemSigilToggleableBase implements IModAddition {
    ...
    public void onSigilUpdate(ItemStack stack, World world, EntityPlayer player, int itemSlot, boolean isSelected) {
        if(!PlayerHelper.isFakePlayer(player)) {
            ...
            if(ModIds.simpledifficulty.isLoaded) {
                //TODO: RFG sucks so check with newest forge version.
    ...
    public void registerRecipe() {
        BloodMagicAdditions.addGuideEntry("architect", "sigil_temperature");

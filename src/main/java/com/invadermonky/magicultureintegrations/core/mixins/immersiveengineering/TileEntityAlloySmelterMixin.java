...
public abstract class TileEntityAlloySmelterMixin extends TileEntityMultiblockPart<TileEntityAlloySmelter> implements IIEInventory, IEBlockInterfaces.IActiveState, IEBlockInterfaces.IGuiTile, IEBlockInterfaces.IProcessTile, IBoostableTile {
    ...
    protected TileEntityAlloySmelterMixin(int[] structureDimensions) {

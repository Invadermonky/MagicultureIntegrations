...
public abstract class TileHeatingStructureMixin<T extends MultiblockDetection> extends TileMultiblock<T> implements IBoostableTile {
    @Shadow protected int[] itemTemperatures;
    @Shadow protected int[] itemTempRequired;
    @Shadow public abstract boolean hasFuel();

    public TileHeatingStructureMixin(String name, int inventorySize) {
